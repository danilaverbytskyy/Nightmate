                    ...
                    <div class="card-body p-4 p-sm-5">
                        ...
                        <form method="post" action="{{ route('auth.store') }}" class="needs-validation" novalidate>
                            ...
                            <div class="form-floating mb-3">
                                <input name="name" type="text" class="form-control" id="floatingName" placeholder="Name" required>
                            ...
                            <div class="d-grid">
                                <input value="Создать аккаунт" class="btn btn-primary btn-login text-uppercase fw-bold" type="submit">
                            </div>
                            <hr class="my-4">
                            <div class="d-grid mb-2">
                                <a href="{{ route('auth.sign-in') }}" class="text-center">Уже зарегистрированы?</a>
                            </div>
                        </form>
                    </div>
                </div>
